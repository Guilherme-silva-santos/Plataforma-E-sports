...
export function CreateAdModal () {
    ...
    const [games, setGames] = useState<Game[]>([]) // fala que game é um array e possui o formato acima <Game[]>
                ...
                <form onSubmit={handleCreateAd}className='mt-8 flex flex-col gap-4'>
                      ...
                      <select id='game' name='game'
                       ...
                       > 
                        ...
                        { games.map(game => {
                            ...
                            {/* // key serve para que o react indentifiqeue o elemento dentro os outros elementos presentes com mesmo nome */}
                    ...
                    <div className='grid grid-cols-2 gap-6'>
                      <div className='flex flex-col gap-2'>
                        ...
                        <Input name='yearsPlaying' id='yearsPlaying' type="text" placeholder='Tudo bem ser 0' />
                      </div>
                    ...
                    <div className='flex gap-6'>
                      ...
                      <label htmlFor="weekDays">Quando costuma jogar ?</label>
                        ...
                        <ToggleGroup.Root className='grid grid-cols-4 gap-1' type='multiple'
                        value={weekDays}
